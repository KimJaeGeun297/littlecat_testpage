...
class CloseDogFileUpload extends StatefulWidget {
  const CloseDogFileUpload({Key? key}) : super(key: key);

  @override
  State<CloseDogFileUpload> createState() => _CloseDogFileUploadState();
}

class _CloseDogFileUploadState extends State<CloseDogFileUpload> {
  ...
  static const jsonString = '{"mode": "C", "type": "D"}';
